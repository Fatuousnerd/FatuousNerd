    ...
    <>
      ...
      <div className='h-screen w-full relative flex flex-col items-center justify-center top-[70px] p-[25px] lg:p-[50px] gap-[60px] '>
        ...
        <div className="flex items-center justify-center gap-[25px]">
          <Link to="/get-started" className='p-[10px] rounded-md bg-[--HTextLight] font-bold uppercase outline-none hover:scale-[1.05] hover:shadow-md hover:shadow-[--HText] duration-500 transition-all  '>Get Started</Link>
